...
public:
     ...
     * @return 是否处理成功
     */
    virtual int32_t handle(pudge::http::HttpRequest::ptr request
                   , pudge::http::HttpResponse::ptr response
                   , pudge::http::HttpSession::ptr session) = 0;    
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (pudge::http::HttpRequest::ptr request
                   , pudge::http::HttpResponse::ptr response
                   , pudge::http::HttpSession::ptr session)> callback;
    ...
    virtual int32_t handle(pudge::http::HttpRequest::ptr request
                   , pudge::http::HttpResponse::ptr response
                   , pudge::http::HttpSession::ptr session) override;
private:
    /// 回调函数
    callback m_cb;
};
